...
shell.run("wget https://raw.githubusercontent.com/Ai-Kiwi/ToasterOS3/main/SystemFiles/UserTemplate/ProgramShortcuts/FileExplorer UserData/" .. NewUserName .. "/ProgramShortcuts/FileExplorer")
