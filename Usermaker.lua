...
shell.run("wget https://raw.githubusercontent.com/Ai-Kiwi/ToasterOS3/main/SystemFiles/UserTemplate/ProgramShortcuts/File%20Explorer UserData/" .. NewUserName .. "/ProgramShortcuts/Worm")
